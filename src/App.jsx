        ...
        <div className="min-h-screen bg-gray-50 dark:bg-gray-950 text-gray-900 dark:text-gray-100 transition-colors duration-200">
          <header className="bg-white dark:bg-gray-900 border-b border-gray-100 dark:border-gray-800 mb-8 sticky top-0 z-50 shadow-sm">
            <div className="max-w-5xl mx-auto px-4 h-16 flex justify-between items-center">
              <a href="/" className="text-2xl font-black text-orange-500 tracking-tight">
                ☀️ Summer Squad
              </a>
          ...
          <main className="max-w-5xl mx-auto px-4">
            <Routes>
              ...
              <Route path="/event/:id" element={<div className="bg-white dark:bg-gray-900 p-6 rounded-xl shadow-sm border border-gray-100 dark:border-gray-800">PAGINA DETTAGLIO (Work in progress)</div>} />
            </Routes>
          </main>
        </div>
      )}
