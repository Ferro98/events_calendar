    ...
    <div className="bg-white dark:bg-gray-900 p-6 rounded-2xl shadow-sm border border-gray-100">
      ...
      <div className="h-[400px] md:h-[600px] text-sm font-sans">
        <Calendar
          ...
          eventPropGetter={() => ({
            className:
              "!bg-orange-500 !text-white !rounded-md !border-none !px-2 !py-0.5 shadow-sm font-medium hover:!bg-orange-600 transition cursor-pointer",
          })}
        />
      </div>
    </div>
